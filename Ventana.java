        ...
        btnCalcularEstTotales.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (control.getListaAvengers().isEmpty()){
                    ...
                    String totalAportes = String.format("%.1f", control.totalAportes());
                    String totalImpuestos = String.format("%.1f", control.totalImpuestos());
                    txtInfoEstTotales.setText("====Estadisticas Totales====" + "\n" + "\nTotal Aportes: " + totalAportes + "$" + "\nTotal de Impuestos: " + totalImpuestos + "$" + "\nTotal Pagos Netos: " + totalPNetos + "$");
                }
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                if (control.getListaAvengers().isEmpty()){
                    ...
                    if (listEstadisticaAvengers1.getSelectedIndex()!= -1){
                        ...
                        String totalAportes = String.format("%.1f", avEst.calcularAporteFondo());
                        String totalImpuestos = String.format("%.1f", avEst.calcularImpuesto());
                        JOptionPane.showMessageDialog(null, "Calculando....");
                        ...
                        txtInfoEstAvenger.append("\nTotal Aportes: "+totalAportes+"$");
                        txtInfoEstAvenger.append("\nImpuesto anual del Avenger: "+totalImpuestos+"$");
